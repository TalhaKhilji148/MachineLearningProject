...
function onClickedEstimatePrice() {
    ...
    var House_location = document.getElementById("uiLocations");
    var estPrice = document.getElementById("uiEstimatedPrice");
    
  
    var url = "http://127.0.0.1:5000/predict_flats_price"; 
    var squarefeet=parseFloat(sqft.value)
    ...
    if(squarefeet>0){
        if(squarefeet<3000){
            $.post(url, {
                ...
                beds: bhk,
                baths: bathrooms,
                House_location: House_location.value
            },
            ...
            alert("Sorry! Can't Estimate the Price, The value for Squarefeet should be less then 3000.")
...
function onPageLoad() {
    ...
    //using Jquery $ to get the request 
     var url = "http://127.0.0.1:5000/get_location_names_for_flats"; 
